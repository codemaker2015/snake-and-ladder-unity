...
public class GameControl : MonoBehaviour {
    ...
    private static GameObject resultPanel, player1MoveText, player2MoveText,player3MoveText, player4MoveText;
...
//
            ...
            player1.GetComponent<FollowThePath>().waypoints.Count)
        {
            ...
            resultPanel.transform.GetChild(0).GetComponent<Text>().text = "Player 1 Wins";
            gameOver = true;
        }
        ...
        {
            resultPanel.gameObject.SetActive(true);
            resultPanel.transform.GetChild(0).GetComponent<Text>().text = "Player 2 Wins";
            gameOver = true;
        }
        if (player3.GetComponent<FollowThePath>().waypointIndex ==
        ...
        {
            resultPanel.gameObject.SetActive(true);
            resultPanel.transform.GetChild(0).GetComponent<Text>().text = "Player 3 Wins";
            gameOver = true;
        }
        if (player4.GetComponent<FollowThePath>().waypointIndex ==
        ...
        {
            resultPanel.gameObject.SetActive(true);
            resultPanel.transform.GetChild(0).GetComponent<Text>().text = "Player 4 Wins";
            gameOver = true;
        }
    }
    ...
    public void MainMenu() {
        SceneManager.LoadScene("SnakeAndLadderMenu");
    }
